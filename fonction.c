...
int sortieMatrice(Matrice *m, int x, int y, int taille, Orientation o){
    /*
        Permet de verifier si un navire ne sort pas de la matrice.
        Param. :
            m :
            x :
            y :
            ...
            o :
        Return :
            Retourn un entier représentant un booléen vrai / faux.
    */
...
int naviresColles(Matrice *m, int x, int y, int taille, Orientation o, int** tab){
    /*
        Permet de vérifier si 2 navires se supperpose ou sont trop proche.
        Param. :
            m :
            x :
            y :
